 ...
 * @author Badri
 */
public class ExcelImporter implements DropTargetListener{
    private DropTarget dt;
    private JTable jtable;
    private DefaultTableModel TableModel = new DefaultTableModel();
    
    public ExcelImporter( JTable jtable ){
        this.jtable = jtable;
                    ...
                    if( !list.isEmpty() ){ /* abre el primer archivo */                        
                        ...
                        if ( file.exists() ){     
                            ...
                            if( file.getName().endsWith("xls") )
                            {
                                ...
                                JOptionPane.showMessageDialog(null,"Fichier Excel  .xls invalide","Error", JOptionPane.ERROR_MESSAGE );                                
                            }                            
            ...
            if( workbook.getNumberOfSheets() > 0 ){
                ...
                {   
                    for ( int columna = 0; columna  < hoja.getColumns() ; columna++ )
                    {
                       ...
                       // columNames[columna]={"Columna " ,"column"};
